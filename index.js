...
// using tables..          
               var resultText = '<pre><table style="border:0px;margin:0px;padding:0px;width:0%;"><tbody>';                
                for(var line = 0; line < lines.length; line++){          
                      resultText += '<tr class="codeline"  style="background-color:rgb(248,248,248);border:initial;">'
...
// using spans..   cleaner, but numbers higlight in chrome              
